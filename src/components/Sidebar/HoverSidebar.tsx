...
const HoverSidebar: React.FC<HoverSidebarProps> = ({ items }) => {
  ...
  return (
    <div className="flex items-center justify-center space-x-4 bg-gray-50 p-3 rounded-lg border border-gray-200">
      {items.map((item, index) => (
        ...
        >
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-colors duration-200"
          >
